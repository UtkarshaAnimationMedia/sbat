        ...
        <div class="col-12">
          <div class="card card-registration card-registration-2 mb-4" style="border-radius: 15px;">
            <div class="card-body p-3">
              ...
              // print_r($this->session->userdata($session_data)['totalPrice']);
              if ($this->session->userdata(@$session_data) != '' && $this->session->userdata(@$session_data)['totalPrice']  != 0) { ?>
                ...
                <div class="row g-0">
                  <div class="col-lg-7" style="background-color:#f5f5f5">
                    <div class="p-5">
                      ...
                      foreach ($cart_items['ids'] as $key => $value) { ?>
                        ...
                        <div class="row mb-4 d-flex justify-content-between align-items-center">
                          ...
                          <div class="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                            <h6 class="mb-0 text-end"><span style="font-weight:bold!important;"><?= @$GeneralSettings['currencySymbol'].' '.price_format($cart_items['serviceAmount'][$key], 2); ?></span></h6>
                          </div>
                        </div>
                      <?php } ?>
                      ...
                      <div class="row mt-3">
                        ...
                        <div class="col-md-2 text-end"><span style="font-weight:bold!important;"><?=@$GeneralSettings['currencySymbol']?> <?=price_format( $cart_items['totalPrice'], 2);?></span></div>
                      ...
                      <?php if (@CheckEmptyNullVar($GeneralSettings['TaxPercent']) != '' && @$GeneralSettings['TaxPercent'] > 0) { ?>
                        ...
                        <div class="row mt-3">
                          ...
                          <div class="col-md-2 text-end"><span style="font-weight:bold!important;"><?=@$GeneralSettings['currencySymbol']?> <?= ( price_format( $cart_items['totalPrice'], 2) * price_format( @$GeneralSettings['TaxPercent'], 2 ) ) / 100;?></span></div>
                      ...
                      <div class="row p-3" style="background-color:#dbdbdb">
                        ...
                        <div class="col-md-4"><h4 class="text-dark text-end" style="margin-top:auto;margin-bottom:auto;font-weight: bold!important;"><?=@$GeneralSettings['currencySymbol']?> <?=  price_format((((  $cart_items['totalPrice'] *  @$GeneralSettings['TaxPercent'] ) / 100) +  $cart_items['totalPrice']), 2);?></h4></div>
                  ...
                  <div class="col-lg-5">
                    <div class="p-5">
                      <div class="row">
                        <div class="col-md-8 fw-bold text-start"><h5 class="mb-2" style="color:#009688!important"><?= @$this->session->userdata('refDataName');?></h5><span><?=@ base64_decode($this->session->userdata('email')) ;?></span></div>
                        <div class="col-md-4 fw-bold text-end" style="color:#009688!important"><?=formatPhoneNumber(@base64_decode($this->session->userdata('phone')));?></div>
                      ...
                      <?php if(@$GeneralSettings['AcharyaSambhavana'] == 1 ){ ?>
                        <div class="row p-3" style="background-color:#dbdbdb">
                          <div class="col-md-9"><h6 class="fw-bold" style="margin-top:auto;margin-bottom:auto;">Acharya Sambhavana (<?=@$GeneralSettings['currencySymbol']?>)</h6></div>
                          <div class="col-md-3 text-end">
                            <input type="number" name="acharya_sambhavana" placeholder="<?=@$GeneralSettings['currencySymbol']?> 0.00" class="form-control form-control-sm" id="acharya-sambhavana-input">
                          </div>
                      ...
                      <?php if(@$GeneralSettings['GeneralDonationAmount'] == 1 ){ ?>
                        <div class="row p-3" style="background-color:#dbdbdb">
                          <div class="col-md-9"><h6 class="fw-bold" style="margin-top:auto;margin-bottom:auto;">General Donation Amount (<?=@$GeneralSettings['currencySymbol']?>)</h6></div>
                          <div class="col-md-3 text-end">
                            <input type="number" name="general_donation" placeholder="<?=@$GeneralSettings['currencySymbol']?> 0.00" class="form-control form-control-sm" id="general-donation-input">
                          </div>
                      ...
                      $subTotal =  price_format(((( $cart_items['totalPrice'] * @$GeneralSettings['TaxPercent'] ) / 100) +  $cart_items['totalPrice']), 2);  
                      ...
                      <div class="d-flex justify-content-between my-4">
                        ...
                        <h3 class="fw-bold text-end" style="border: 2px solid #dbdbdb;border-radius: 9px;padding: 3px;" id="total-price"><?=@$GeneralSettings['currencySymbol']?> <?=  price_format((((  $cart_items['totalPrice'] *  @$GeneralSettings['TaxPercent'] ) / 100) + $cart_items['totalPrice']), 2 );?> </h3>
                      </div>
                      ...
                      <div class="text-center my-3">
                        ...
                        <?php }else if(isset($generalSettings['isMultipleSelect']) && $generalSettings['isMultipleSelect'] == 'NO'){ ?> 
                         <a href="javascript:void(0)" class="btn btn-success" style="background-color: #ffc107;padding: 5px 14px;color: #15102e;border-radius: 6px!important;font-size: 17px;font-weight: 1000;border: 0px!important;margin: 0px 8px;" onclick="BookNow()">
...
// Wait for the page to finish loading
  ...
  // Function to update the total price based on the input values
    ...
    // Update the total price element
      $totalPrice.text('<?=@$GeneralSettings['currencySymbol']?> ' + newTotalPrice.toFixed(2));
    }
...
// set up the transaction
    createOrder: (data, actions) => {
      ...
      amt = parseFloat($('#total-price').text().replace('<?=@$GeneralSettings['currencySymbol']?> ', '')) || 0;
