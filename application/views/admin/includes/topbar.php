					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
							...
							<div style="right: 33px!important;position: absolute;vertical-align: middle!important;">
								...
								<?php }else if($header == 'MY-ANNUAL-EVENTS'){ ?> 

									<a href="<?=base_url('admin/add-annual-events')?>" style="padding-right:5px;color: #0d6efd00;"><img src="<?=base_url('admin_assets/img/icons/add-icon.png')?>" height="40"width="40" style="vertical-align: middle!important;"></a>

								<?php }else if($header == 'ADD-ANNUAL-EVENTS'){ ?> 

									<a id="addAnnualEventBtn" style="padding-right:5px;color: #0d6efd00;" onclick="submitForm()"   href="javascript:void(0)"><img src="<?=base_url('admin_assets/img/icons/save-icon.png')?>" height="40"width="40" style="vertical-align: middle!important;"></a>
